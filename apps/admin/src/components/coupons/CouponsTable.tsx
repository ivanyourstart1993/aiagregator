...
import { deleteCouponAction } from '@/app/[locale]/(panel)/coupons/actions';
            ...
            <TableRow key={c.id}>
              ...
              <TableCell className="text-right">
                <div className="flex justify-end gap-1">
                  <Button asChild size="sm" variant="ghost" title={t('viewRedemptions')}>
                    <Link href={`/coupons/${c.id}/redemptions`}>
                      <Eye className="h-4 w-4" />
                    </Link>
                  </Button>
                  <Button asChild size="sm" variant="ghost" title={tCommon('edit')}>
