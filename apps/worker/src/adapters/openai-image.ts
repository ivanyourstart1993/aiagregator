...
// gpt-5 / o-series are reasoning models: chat/completions requires
// `max_completion_tokens` (not `max_tokens`) and rejects a custom
// `temperature` (only the default is allowed).
