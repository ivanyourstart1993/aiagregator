...
import { BundlePicker } from '@/components/admin/pricing/BundlePicker';
...
import {
  createCouponAction,
  updateCouponAction,
} from '@/app/[locale]/(admin)/admin/coupons/actions';
...
export function CouponForm({ mode, coupon, bundles = [] }: Props) {
  ...
  // Edit mode: limited subset of fields
  if (mode === 'edit' && coupon) {
    return <EditForm coupon={coupon} pending={pending} startTransition={startTransition} t={t} tForm={tForm} tCommon={tCommon} />;
  }
...
function CreateForm({
  ...
  function submit(e: React.FormEvent) {
    ...
    if (needsBundle && bundleId) body.bundleId = bundleId;
